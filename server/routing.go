...
func RegisterRoutes(e *gin.Engine, config map[string][]gin.HandlerFunc, dal DataAccessLayer, serverConfig Config) {
	...
	RegisterController("AdministrableProductDefinition", e, config["AdministrableProductDefinition"], dal, serverConfig)
	...
	RegisterController("CapabilityStatement2", e, config["CapabilityStatement2"], dal, serverConfig)
	...
	RegisterController("ClinicalUseIssue", e, config["ClinicalUseIssue"], dal, serverConfig)
	...
	RegisterController("ConditionDefinition", e, config["ConditionDefinition"], dal, serverConfig)
	...
	RegisterController("Ingredient", e, config["Ingredient"], dal, serverConfig)
	...
	RegisterController("ManufacturedItemDefinition", e, config["ManufacturedItemDefinition"], dal, serverConfig)
	...
	RegisterController("MedicationUsage", e, config["MedicationUsage"], dal, serverConfig)
	RegisterController("MedicinalProductDefinition", e, config["MedicinalProductDefinition"], dal, serverConfig)
	...
	RegisterController("NutritionIntake", e, config["NutritionIntake"], dal, serverConfig)
	...
	RegisterController("PackagedProductDefinition", e, config["PackagedProductDefinition"], dal, serverConfig)
	...
	RegisterController("RegulatedAuthorization", e, config["RegulatedAuthorization"], dal, serverConfig)
	...
	RegisterController("Statistic", e, config["Statistic"], dal, serverConfig)
	...
	RegisterController("SubstanceDefinition", e, config["SubstanceDefinition"], dal, serverConfig)
	...
	RegisterController("Topic", e, config["Topic"], dal, serverConfig)
